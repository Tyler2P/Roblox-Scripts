...
destroy.MouseButton1Down:connect(function()
	...
	SendNotification("Warning", "Wait until you turn into an inmate before equipping REMINGTON 870")
    for i, v in pairs(game:GetService("Players"):GetChildren()) do
        for i = 1, 650 do
            local tbl_36BA2890 = {
                ["RayObject"] = Ray.new(Vector3.new(839.947937, 99.4999466, 2211.61719),
                    Vector3.new(-379.812744, 31.2091656, 121.524826)),
                ["Distance"] = 61.344123840332,
                ["Cframe"] = CFrame.new(809.089844, 101.766418, 2219.49268, 0.363455683, 0.0792314336, -0.928236127,
                    -1.86264515e-09, 0.996376872, 0.0850477219, 0.931611478, -0.0309110768, 0.362138808),
            ...
            local tbl_36B5BF78 = {
                ...
                ["Cframe"] = CFrame.new(809.180542, 102.100838, 2219.57886, 0.366918802, 0.0893238857, -0.92595464, 0,
                    0.995379448, 0.0960210636, 0.930253029, -0.035231933, 0.365223378),
                ["Hit"] = v.Character.Head
            }
            local tbl_36B585E8 = {
                ["RayObject"] = Ray.new(Vector3.new(839.947937, 99.4999466, 2211.61719),
                ...
                ["Cframe"] = CFrame.new(809.180542, 100.912926, 2219.61255, 0.36787042, 0.0533849634, -0.928343356, 0,
                    0.99835068, 0.0574107729, 0.929877102, -0.021119725, 0.367263645),
                ["Hit"] = v.Character.Head
            }
            local tbl_36B5CC38 = {
                ["RayObject"] = Ray.new(Vector3.new(839.947937, 99.4999466, 2211.61719),
                ...
                ["Cframe"] = CFrame.new(808.680542, 102.047562, 2221.70142, 0.418726623, 0.0821772888, -0.90438652, 0,
                    0.995897233, 0.0904924273, 0.908112347, -0.0378915891, 0.417008668),
                ["Hit"] = v.Character.Head
            }
            local tbl_36B5BB28 = {
                ["RayObject"] = Ray.new(Vector3.new(839.947937, 99.4999466, 2211.61719),
                ...
                ["Cframe"] = CFrame.new(808.680542, 101.319054, 2220.68823, 0.391926825, 0.0631896704, -0.917823792, 0,
                    0.997638524, 0.0686846897, 0.91999644, -0.0269193724, 0.391001284),
                ["Hit"] = v.Character.Head
            }
            local tbl_36B58A98 = {tbl_36B5BB28, tbl_36B5CC38, tbl_36B585E8, tbl_36B5BF78, tbl_36BA2890}
            local tbl_main = {tbl_36B58A98, game:GetService("Players").LocalPlayer.Backpack["Remington 870"]}
        ...
        do
            for i, v in pairs(game.Teams["Guards"]:GetPlayers()) do
                for o, l in pairs(game.Teams["Inmates"]:GetPlayers()) do
                    local tbl_main = {game:GetService("Workspace")["Prison_ITEMS"].single["Crude Knife"].ITEMPICKUP}
                        ...
                        for o, l in pairs(game.Teams["Inmates"]:GetPlayers()) do
                            if v.Name ~= game.Players.LocalPlayer.Name then
                                if l.Name ~= game.Players.LocalPlayer.Name then
                                    local tbl_main = {v, game:GetService("Players").LocalPlayer.Backpack["Crude Knife"]}
                                    game:GetService("ReplicatedStorage").meleeEvent:FireServer(unpack(tbl_main))
                                    local tbl_main = {l, game:GetService("Players").LocalPlayer.Backpack["Crude Knife"]}
                                    game:GetService("ReplicatedStorage").meleeEvent:FireServer(unpack(tbl_main))
                                    ...
                                    lol = false
                                    if lol == false then
                                        Bruh.CFrame = CFrame.new(-920.510803, 92.2271957, 2138.27002, 0, 0, -1, 0, 1, 0,
                                            1, 0, 0)
                                        Bruh.Size = Vector3.new(6, 0.2, 6)
                                        Bruh.Transparency = 0
                                        lol = false
