...
Title.Text = "IISpoinks's Exploit GUI"
...
function SCRIPT_OJXE82_FAKESCRIPT() -- Players.GetPlayers 
    ...
    local buttons = {script.Parent.Player1, script.Parent.Player2, script.Parent.Player3, script.Parent.Player4,
                     script.Parent.Player5, script.Parent.Player6, script.Parent.Player7, script.Parent.Player8,
                     script.Parent.Player9, script.Parent.Player10, script.Parent.Player11, script.Parent.Player12}
